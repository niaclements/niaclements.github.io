...
View the grant submission here (right click to open in new tab): [FEMA-Style Grant Application](assets/img/grant.pdf)
...
View the Epidemiological Profile here (right click to open in new tab): [Epidemiological Profile for Opioid Use Disorder](assets/img/EpiProfile_Portfolio.pdf)
...
View the paper here (right click to open in new tab): [Biosocioecological Evaluation of PFAS](assets/img/PFAS.pdf)
...
View the literature review here (right click to open in new tab): [Poverty Alleviation Literature Review](assets/img/Povertyalleviation.pdf)
...
View the paper here (right click to open in new tab): [Health Outcomes Analysis](assets/img/Clements_HuntsPointSystemsHealthOutcomesAnalysisPaper.pdf)  
View the systems diagram here (right click to open in new tab): [Systems Diagram](assets/img/Clements_HuntsPointSystemsHealthOutcomesAnalysisSystemsDiagram.pdf)
